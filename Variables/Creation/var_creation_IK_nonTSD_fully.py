...
get_user_detail_from_api = {
	"url": "http://10.22.68.64",
	"uri": "/etfs/web/access/get-userdetail-byid",
	"method": "GET",
	"params": "",
	"headers":{"Authorization":"","Content-Type":"application/json"},
	"body":""
...
get_unit_holder_account_525_from_api = {
	"url": "http://10.22.68.64",
	"uri": "/etfs/web/common/get-unit-holder-name-by-ref",
	"method": "GET",
	"params": {"amSysPartiID":"208","unitHolderId":"5250001","referenceTypeId":"1","referenceNo":"1234569876543","sysNationalityId":"1"},
	"headers":{"Authorization":"","Content-Type":"application/json"},
	"body":""
}
