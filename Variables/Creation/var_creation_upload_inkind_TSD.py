...
get_account_name_from_api = {
	...
	"params": {"partiID":"011","accountNo":"0110000017","unitHolderId":"","brokerageAccountId":"",
               "referenceType":"","referenceNo":"","nationalityCod":"","amSysPartiID":"43"},
	"headers":{"Authorization":"","Content-Type":"application/json"},
	"body":""
}

# http://10.22.68.64/etfs/web/common/etf-get-account-name?partiID=002&accountNo=&unitHolderId=&brokerageAccountId=10013711&referenceType=0&referenceNo=3102002587675&nationalityCode=000
get_pd_account_name_from_api = {
    "url": "",
	"uri": "/etfs/web/common/etf-get-account-name",
	"method": "GET",
	"params": {"partiID":"002","accountNo":"","unitHolderId":"","brokerageAccountId":"10013711",
               "referenceType":"0","referenceNo":"3102002587675","nationalityCode":"000","amSysPartiID":"43"},
	"headers":{"Authorization":"","Content-Type":"application/json"},
	"body":""
}
...
get_am_account_name_from_api = {
	...
	"uri": "/etfs/web/common/etf-get-account-name",
	"method": "GET",
	"params": {"partiID":"200","accountNo":"","unitHolderId":"23344555","brokerageAccountId":"",
               "referenceType":"0","referenceNo":"3400900688034","nationalityCode":"000","amSysPartiID":"43"},
	"headers": {"Authorization":"","Content-Type":"application/json"},
	"body":""
}
